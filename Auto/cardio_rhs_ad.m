function dy = cardio_rhs_ad(t,y,pars)
T=1;
...
% qalp = (y(3) - y(4))./Ralp;
 ...
 dy =  [(((plv - y(1))./Ravop) - ((y(1) - y(3))./Ral) - ((y(1) - y(2))./Raup))./Cau; ...   %pau 
        (((y(4) - y(2))./Rvl) + ((y(1) - y(2))./Raup) - ((y(2) - plv)./Rmvop))./Cvu; ...   %pvu 
        (((y(1) - y(3))./Ral) - ((y(3) - y(4))./Ralp))./Cal; ...                           %pal
        (((y(3) - y(4))./Ralp) - ((y(4) - y(2))./Rvl))./Cvl; ...                           %pvl
        (((y(2) - plv)./Rmvop) - ((plv - y(1))./Ravop));];                                 %Vlv
