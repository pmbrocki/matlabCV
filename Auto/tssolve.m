function [RS,RSx0,GS,GSx0]=tssolve(odename,x0,q,tint,sensflag,options)
...
[t,sens]=ode15s(@odewsensAD,tint,[x0;zeros(m*n,1);...
    reshape(diag(ones(n,1)),n^2,1)],options,q,odename);
N=length(t);
